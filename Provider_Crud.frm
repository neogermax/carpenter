...
Private Sub BtnCreate_Click()
    ...
    If validate = 1 Then
        ...
        LblhelpGeneral.Caption = "Para poder generar el prveedor debe registrar los campos obligatorios señalados en la parte superior!"
    ...
    Else
        ...
        If Proccess = "CREAR PROVEEDOR" Then
...
Private Sub BtnSearch_Click()
    ...
    If validate = 1 Then
        LblhelpGeneral.Visible = True
        LblhelpGeneral.Caption = "Para poder generar el PROVEEDOR debe registrar los campos obligatorios señalados en la parte superior!"
        LblhelpGeneral.ForeColor = &H80&
    Else
        
        ' traer los datos del registro seleccionado
        Traer_Datos = C_Provider.Charge_List_Provider(op_Search, CbnSearch.Text)
        ...
        If Proccess = "ELIMINAR PROVEEDOR" Then
            block
        End If
...
Private Sub Opdoc_Click()
    ...
    'cargamos consulta datos documentos en BD
    cargar_datos = C_Proc.Datos_Charge("Provider", "Add_Doc")
    
    'traemos la cantidad de doc en BD
    Q_cargar_datos = C_Proc.Q_Combo("Provider")
...
Private Sub OpName_Click()
    ...
    'cargamos consulta datos documentos en BD
    cargar_datos = C_Proc.Datos_Charge("Provider", "Add_Name")
...
'LLAMAR METODO MODIFICAR PROVEEDOR
Function Update()
...
'LLAMAR METODO ELIMINAR PROVEEDOR
Function Delete()
